...
namespace OnlineShopp.Controllers
{
    ...
    {
        private readonly OnlineShoppContext _context;

        public KonsumenController(OnlineShoppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKonsumen,NamaKonsumen,Alamat,NoHp")] Konsuman konsuman)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKonsumen,NamaKonsumen,Alamat,NoHp")] Konsuman konsuman)
        {
